...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    /* 테마/방향/기본 옵션이 공유되는 Context의 공급자 역할=================================================================== */
...
// ViewHarness ================================================================================================================
    ...
    */
    ...
    /* An abstracdaygridt class for the  views, as well as month view. Renders one or more rows of day cells.
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    */
    ...
    class SingleMonth extends DateComponent {
        ...
        render() {
            ...
            return (y("div", 
                y("div",
                    y("div", context.dateEnv.format(props.dateProfile.currentRange.start, props.titleFormat))),
                y("div", { className: [
                        'fc-daygrid',
                        'fc-daygrid-body',
