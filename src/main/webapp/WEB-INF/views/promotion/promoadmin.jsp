...
<sec:authorize access="hasRole('ADMIN')">
    <div class="container">
        ...
        <div class="search-area">
            <form action="${contextPath}/promoAdmin" method="get" class="search-form">
                ...
                <input type="text" name="keyword" placeholder="search" value="${fn:escapeXml(keyword)}" class="form-control me-2" style="max-width: 250px;" />
        ...
        <div class="pagination-area">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li class="page-item <c:if test='${pi.currentPage <= 1}'>disabled</c:if>">
                    ...
                    <li class="page-item <c:if test='${pi.currentPage >= pi.totalPage}'>disabled</c:if>">
            ...
            .then((confirmed) => {
                if (confirmed) {
                    ...
                    fetch(contextPath + '/promoAdmin/deletePromoPost', {
                        ...
                        body: 'promoId=' + encodeURIComponent(promoId)
                    })
                    .then(response => {
                        if (!response.ok) {
