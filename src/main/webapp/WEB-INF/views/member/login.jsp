        ...
        <div class="content">
            ...
            <div id="tab1" data-tab-content class="items active">
                <div class="container">
                    ...
                    <form method="post" action="" id="login-form1">
                    ...
                    <form method="get" action="${pageContext.request.contextPath}/member/join">
            ...
            <div id="tab2" data-tab-content class="items">
                <div class="container">
                    ...
                    <form method="get" action="${pageContext.request.contextPath}/member/join2">
                        <button class="bt2" type="submit"><span class="tx1">회원가입</span></button>
                    </form>
                </div>
            </div>
        </div>
